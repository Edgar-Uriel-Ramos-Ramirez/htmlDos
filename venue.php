...
<!-- ---------------------------------------------------------------------------------------------------------------------------------------------------------------- -->
    ...
    <article class="parteIzquierda">
        ...
        <article class="pirmeraParteIzquierda">
            <h1>The Venue</h1>
            <img class="derecha" src="images/hotel_contempo.jpg">
            <aside class="textoHotel">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ex, ipsa incidunt 
        ...
        <div class="priemraImagen">
            <img class="derecha" src="images/hotel_phillips.jpg" width="28%">
            <h2>Phillips of Bell town</h2>
        ...
        <div class="segundaImagen">
            <img class="derecha" src="images/hotel_otter.jpg" width="28%">
            <h2>The Otter Renaissance Hotel</h2>
        ...
        <div class="terceraImagen">
            <img class="derecha" src="images/hotel_rage.jpg" width="28%">
            <h2>The Rage Hotel</h2>
            <aside class="textoPrimeraImg" style="margin:-4% 0";>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ex, ipsa incidunt 
                ad sunt praesentium error alias nihil quia earum laborum consequatur voluptate consequuntur, ipsum expedita excepturi iste sed magni rem?
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Cupiditate debitis totam voluptatum a corporis. 
            </aside>
        ...
        <div class="cuartaImgaen">
            <img class="derecha" src="images/hotel_gwendoline.jpg" width="28%">
            <h2>Gwendoline's Fancy</h2>
            <aside class="textoPrimeraImg" style="margin:-4% 0";>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ex, ipsa incidunt 
                ad sunt praesentium error alias nihil quia earum laborum consequatur voluptate consequuntur, ipsum expedita excepturi iste sed magni rem?
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Cupiditate debitis totam voluptatum a corporis. 
            </aside>
